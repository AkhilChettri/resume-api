...
app.use('/api/content/work-experience', JobExperience);
app.use('/api/content/education', EducationRoute);
app.use('/api/content/skills', SkillRoute);
app.use('/api/content/summary', SummaryRoute);
app.use('/api/content/other-fields', OtherFieldRoute);
